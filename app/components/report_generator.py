...
def generate_pdf_report(
    ...
    try:
        ...
        pdf.cell(140, 10, datetime.now().strftime("%Y-%m-%d %H:%M:%S"), border=0, new_x=XPos.LMARGIN, new_y=YPos.NEXT)
        ...
        pdf.cell(140, 10, "EfficientNetB0 Transfer Learning", border=0, new_x=XPos.LMARGIN, new_y=YPos.NEXT)
